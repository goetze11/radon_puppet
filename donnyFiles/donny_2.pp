...
file { '/etc/sysconfig/network-scripts/ifcfg-em2':
    ...
    group  => "root",
    mode   => "644",
    source => "/root/radon_puppet/etc_2/sysconfig/network-scripts/ifcfg-em2",}
...
file { '/etc/fstab':
    ...
    group  => "root",
    mode   => "644",
    source => "/root/radon_puppet/etc_2/fstab",}
...
file { '/etc/sysconfig/network-scripts/ifcfg-ib0':    ensure => "file",
    ...
    group  => "root",
    mode   => "644",
    source => "/root/radon_puppet/etc_2/sysconfig/network-scripts/ifcfg-ib0",}
...
cron {'puppetApply':
    command => 'cd /root/radon_puppet && puppet apply donny_2.pp',
    user    => 'root',
    hour    => '9',
    minute  => '32',}

...
file { '/etc/sysconfig/network-scripts/ifcfg-em2':
    ...
    group  => "root",
    mode   => "644",
    source => "/root/radon_puppet/etc_9/sysconfig/network-scripts/ifcfg-em2",}
...
file { '/etc/fstab':
    ...
    group  => "root",
    mode   => "644",
    source => "/root/radon_puppet/etc_9/fstab",}
...
file { '/etc/sysconfig/network-scripts/ifcfg-em1':
    ...
    group  => "root",
    mode   => "644",
    source => "/root/radon_puppet/etc_9/sysconfig/network-scripts/ifcfg-em1",}   
...
file { '/etc/sysconfig/network-scripts/ifcfg-ib0':
    ...
    group  => "root",
    mode   => "644",
    source => "/root/radon_puppet/etc_9/sysconfig/network-scripts/ifcfg-ib0",}
...
file { '/etc/group':
    ...
    group  => "root",
    mode   => "644",
    source => "/root/radon_puppet/etc_9/group",}
...
file { '/etc/passwd':
    ...
    group  => "root",
    mode   => "644",
    source => "/root/radon_puppet/etc_9/passwd",}
...
cron {'puppetApply':
    command => 'cd /root/radon_puppet && puppet apply donny_9.pp',
    user    => 'root',
    hour    => '9',
    minute  => '32',}
